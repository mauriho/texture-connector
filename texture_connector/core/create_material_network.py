...
class CreateMaterialNetwork:
    ...
    def create(self, name: str, use_triplanar: bool, uv_tiling_mode: str) -> None:
        ...
        if not self.name:
            MGlobal.displayError(f'[{CreateMaterialNetwork.TEXTURE_CONNECTOR}] No name for the material.')
            return
    ...
    def _create_emissive_network(self) -> None:
        self.emissive_file_node, self.emissive_triplanar_node = self._create_standard_network(
    ...
    def _create_metalness_network(self) -> None:
        self.metalness_file_node, self.metalness_triplanar_node = self._create_standard_network(
    ...
    def _create_opacity_network(self) -> None:
        self.opacity_file_node, self.opacity_triplanar_node = self._create_standard_network(
    ...
    def _create_roughness_network(self) -> None:
        self.roughness_file_node, self.roughness_triplanar_node = self._create_standard_network(
