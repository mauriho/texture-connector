...
class TextureConnectorSettingsWidget(QtWidgets.QWidget):
    ...
    def _create_widgets(self) -> None:
        ...
        self.render_engine_combo_box.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)

        self.material_texture_map_settings_widget = MaterialTextureMapSettingsWidget()
        self.base_color_settings_widget = self.material_texture_map_settings_widget.get_base_color_settings_widget()
        self.roughness_settings_widget = self.material_texture_map_settings_widget.get_roughness_settings_widget()
        self.metalness_settings_widget = self.material_texture_map_settings_widget.get_metalness_settings_widget()
        self.normal_settings_widget = self.material_texture_map_settings_widget.get_normal_settings_widget()
        self.height_settings_widget = self.material_texture_map_settings_widget.get_height_settings_widget()
        self.emissive_settings_widget = self.material_texture_map_settings_widget.get_emissive_settings_widget()
        self.opacity_settings_widget = self.material_texture_map_settings_widget.get_opacity_settings_widget()
        ...
        self.uv_tiling_mode_combo_box.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
    ...
    def _create_layouts(self) -> None:
        ...
        render_engine_form_layout.addRow('Render Engine: ', self.render_engine_combo_box)
        render_engine_form_layout.setContentsMargins(QtCore.QMargins(43, 3, 3, 3))
        ...
        uv_tiling_mode_form_layout.addRow('UV Tiling Mode: ', self.uv_tiling_mode_combo_box)
        uv_tiling_mode_form_layout.setContentsMargins(QtCore.QMargins(39, 3, 3, 3))
        ...
        triplanar_form_layout.setContentsMargins(QtCore.QMargins(127, 3, 3, 3))
    ...
    def load_settings(self, settings_path: str = '') -> None:
        ...
        self.base_color_settings_widget.set_enabled(s.value('baseColorEnabled',  True, bool))
        self.base_color_settings_widget.set_text(s.value('baseColorSuffix', TextureMaps.BASE_COLOR, str))
        self.base_color_settings_widget.set_color_space(
            s.value('baseColorColorSpace', ColorSpaces.SRGB.value, str))

        self.roughness_settings_widget.set_enabled(s.value('roughnessEnabled',  True, bool))
        self.roughness_settings_widget.set_text(s.value('roughnessSuffix', TextureMaps.ROUGHNESS, str))
        self.roughness_settings_widget.set_color_space(s.value('roughnessColorSpace', ColorSpaces.RAW.value, str))

        self.metalness_settings_widget.set_enabled(s.value('metalnessEnabled',  True, bool))
        self.metalness_settings_widget.set_text(s.value('metalnessSuffix', TextureMaps.METALNESS, str))
        self.metalness_settings_widget.set_color_space(s.value('metalnessColorSpace', ColorSpaces.RAW.value, str))

        self.normal_settings_widget.set_enabled(s.value('normalEnabled',  True, bool))
        self.normal_settings_widget.set_text(s.value('normalSuffix', TextureMaps.NORMAL, str))
        self.normal_settings_widget.set_color_space(s.value('normalColorSpace', ColorSpaces.RAW.value, str))

        self.height_settings_widget.set_enabled(s.value('heightEnabled',  True, bool))
        self.height_settings_widget.set_text(s.value('heightSuffix', TextureMaps.HEIGHT, str))
        self.height_settings_widget.set_color_space(s.value('heightColorSpace', ColorSpaces.RAW.value, str))

        self.emissive_settings_widget.set_enabled(s.value('emissiveEnabled', True, bool))
        self.emissive_settings_widget.set_text(s.value('emissiveSuffix', TextureMaps.EMISSIVE, str))
        self.emissive_settings_widget.set_color_space(s.value('emissiveColorSpace', ColorSpaces.SRGB.value, str))

        self.opacity_settings_widget.set_enabled(s.value('opacityEnabled',  True, bool))
        self.opacity_settings_widget.set_text(s.value('opacitySuffix', TextureMaps.OPACITY, str))
        self.opacity_settings_widget.set_color_space(s.value('opacityColorSpace', ColorSpaces.RAW.value, str))

        self.uv_tiling_mode_combo_box.setCurrentText(s.value('uvTilingMode', UVTilingModes.OFF, str))
