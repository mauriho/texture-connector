...
class MaterialSettingsWidget(QtWidgets.QWidget):
    ...
    def _create_layouts(self) -> None:
        ...
        material_main_h_box_layout.setContentsMargins(QtCore.QMargins(3, 3, 3, 3))
        ...
        material_h_box_layout.setContentsMargins(QtCore.QMargins(3, 3, 3, 3))
        ...
        material_texture_map_settings_v_box_layout.addWidget(self.material_texture_map_settings_widget)
        material_texture_map_settings_v_box_layout.setContentsMargins(QtCore.QMargins(12, 0, 0, 0))
